...
setErrorMessage("");
  ...
  if (!activeOrganizationId) {
    ...
    if (!currentUser) {
      throw new Error(
        "Unable to load the current HIMIG organization."
      );
    }
...
async function loadRoleAndOrganization() {
try {
const user =
await getCurrentHimigUser();
  ...
  await loadSongs(user.organizationId);
} catch (error) {
  console.error(
  ...
  setErrorMessage(
    error instanceof Error
      ? error.message
      : "Unable to load your HIMIG organization."
  );
...
useEffect(() => {
  const timer = window.setTimeout(() => {
    void loadRoleAndOrganization();
    void loadFavorites();
  }, 0);

  return () => window.clearTimeout(timer);

  // These functions intentionally run once when the Song Library mounts.
...
return ( <div className="min-h-screen bg-[#090909] text-white"> <div className="flex min-h-screen">
      ...
      <div className="border-b border-neutral-800 px-6 py-6">
        ...
        >
          <div className="flex items-center gap-3">
            ...
            <div className="flex h-10 w-10 items-center justify-center overflow-hidden rounded-xl border border-neutral-700 bg-neutral-900">
              <Image
                src="/icon.svg"
                alt="HIMIG"
                width={40}
      ...
      <header className="border-b border-neutral-800 bg-[#090909] md:hidden">
        ...
        <div className="flex items-center justify-between px-5 py-4">
          ...
          >
            ...
            <div className="flex h-9 w-9 items-center justify-center overflow-hidden rounded-lg border border-neutral-700 bg-neutral-900">
              <Image
                src="/icon.svg"
                alt="HIMIG"
                width={36}
