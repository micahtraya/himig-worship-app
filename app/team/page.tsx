  ...
  useEffect(() => {
    async function loadTeam() {
      ...
      try {
        ...
        /*
         * Load only members of the current organization.
         *
         * Organization membership is the source of truth
         * for which users belong to this team.
         */
        const {
          data: memberships,
        ...
        /*
         * Build the team list from organization
         * membership records.
         *
         * The membership role is authoritative for
         * this organization.
         */
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="mt-1 text-sm text-neutral-500">
                    Manage your {organizationName} worship team.
                  </p>
